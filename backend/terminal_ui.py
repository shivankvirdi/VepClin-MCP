...
def print_help() -> None:
    ...
    tips.add_row("")
    tips.add_row("[bold]Commands[/bold]")
    tips.add_row("/batch", "Choose a VCF file and summarize multiple variants")
    tips.add_row("/export", "After /batch, save the latest batch results as CSV,TSV,VCF, or Excel file")
    tips.add_row("/report", "After looking up a variant, export the full report as a PDF")
